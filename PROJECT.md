# Ghasper BI API — project profile (Nexus Harness v4)

Nexus registry id: `projects.ghasper-bi-api`
Repository: `Rubens-Marques/ghasper-bi-api`
Client: `ghasper`
Status: `active`
...
- Python API (pytest). Sem workflow GitHub legado.
